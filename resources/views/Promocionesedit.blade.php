...
<body>
    ...
    <form action="{{ url('menu/menuadmon/promociones/edit/' . $promocion->IdPromocion) }}" method="post"
                        ...
                        <div class="uk-margin" uk-margin>
                            <div uk-form-custom="target: true">
                                ...
                                <div class="uk-padding">
                                    <img src="{{ asset('uploads/promocion/' . $promocion->Imagen) }}" alt="120"
                                        height="50" srcset="">
                                </div>
                            ...
                            <input value="{{ $promocion->descripcion }}" class="form-control" id="descripcion"
