...
<head>
    ...
    <title>Pedidos | Serigrafía</title>
    ...
    <nav class="uk-navbar uk-navbar-container uk-margin">
        <div class="uk-navbar-left">
            <a class="uk-navbar-toggle" href="#">
                <span uk-toggle="target: #my-id" uk-navbar-toggle-icon></span> <span class="uk-margin-small-left">Pedidos Serigrafía</span>
            </a>
        </div>
            ...
            peticionapi({}, 'GET', function(res) {
                ...
                res.forEach(pedido => {
                    html +=
                        ...
                        pedido.IDdetalledelpedido + '">' + pedido.IDdetalledelpedido + pedido.primer_nombre + '</td>' + '</a>' +
