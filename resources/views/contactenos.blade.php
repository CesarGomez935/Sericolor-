...
<div uk-margin-right class="uk-position-right ">
    ...
    <div>
        <div class="uk-height-medium uk-card uk-card-default uk-card-body uk-flex uk-flex-middle uk-flex-left uk-padding " style="background-color:bisque">
            ...
            <h1 class="uk-padding">Propietario
                ...
                <h4>+505 55038173</h4>
                <a  class="uk-icon-button  uk-margin-small-right " uk-icon="whatsapp" > </a> 
                <a  class="uk-icon-button  uk-margin-small-right" uk-icon="mail"></a>
                <a  class="uk-icon-button  uk-margin-small-right" uk-icon="phone"></a>
                </div>
            </h1>
