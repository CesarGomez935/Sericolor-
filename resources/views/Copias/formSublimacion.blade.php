                                ...
                                <table class="uk-table uk-table-hover uk-table-divider uk-table-small">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input id="talla_s_dama" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0" value="0"> <textarea id="s_dama_desc"
                                                    name="s_dama_desc" class="uk-input uk-form-width-small"
                                        ...
                                        <tr>
                                            <td id="tallam">M</td>
                                            <td><input id="talla_m_caballero" name=""
                                                    class="uk-input uk-form-width-xsmall" type="Number" placeholder="0"
                                                    value="0"> <textarea id="m_caballero_desc" name="m_caballero_desc"
                                                    class="uk-input uk-form-width-small" type="text"> </textarea></td>

                                            <td><input id="talla_m_dama" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0" value="0"><textarea id="m_dama_desc"
                                                    name="m_dama_desc" class="uk-input uk-form-width-small"
                                                    type="text"> </textarea></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="talla_l_caballero" class="uk-input uk-form-width-xsmall"
                                                    ...
                                                    id="l_caballero_desc" name="l_caballero_desc"
                                                    class="uk-input uk-form-width-small" type="text"> </textarea></td>

                                            <td><input id="talla_l_dama" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0" value="0"><textarea id="l_dama_desc"
                                                    name="l_dama_desc" class="uk-input uk-form-width-small"
                                                    type="text"> </textarea></td>
                            ...
                            <div class="uk-grid-small" uk-grid>
                                <table class="uk-table uk-table-hover uk-table-divider uk-table-small">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td id="12">12</td>
                                            <td><input id="talla_12" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0" value="0"><textarea id="12_desc"
                                                    name="12_desc" class="uk-input uk-form-width-small"
                                                    type="text"></textarea></td>
                                        ...
                                        <tr>
                                            <td id="10">10</td>
                                            <td><input id="talla_10" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0" value="0"><textarea id="10_desc"
                                                    name="10_desc" class="uk-input uk-form-width-small"
                                                    type="text"></textarea></td>
                                    ...
                                    <div class="uk-margin">
                                        ...
                                        <table class="uk-table uk-table-small uk-table-divider">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Cantidad</td>
                                                    <td><input id="cantidad_llavero" type="number"
                                                            class="uk-input"></td>
                                    ...
                                    <div class="uk-margin">
                                        ...
                                        <table class="uk-table uk-table-small uk-table-divider">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Cantidad</td>
                                                    <td><input id="cantidad_lapiz" type="number"
                                                            class="uk-input"></td>
                                ...
                                <table class="uk-table uk-table-hover uk-table-divider">
                                    ...
                                    <tbody id="tabladetalle">
                                        <tr>
                                            ...
                                            <td><input id="cantidad_pedido_1" min="0" value="0"
                                                    oninput="calculo_pedido1();" class="uk-input calculo_pedido1"
                                                    type="number"></td>
                                            <td><input id="especificaciones_pedido_1" class="uk-input"
                                                    type="text"></td>
                                            <td><input id="precio_und_pedido_1" min="0" value="0"
                                                    oninput="calculo_pedido1();" class="uk-input calculo_pedido1"
                                                    type="number"></td>
                                            <td><input id="precio_pedido_1" onchange="pedido();" onclick="pedido();"
                                                    min="0" value="0" class="uk-input pedido" type="number"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="especificaciones_pedido_2" class="uk-input"
                                                    type="text"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="especificaciones_pedido_3" class="uk-input"
                                                    type="text"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="especificaciones_pedido_4" class="uk-input"
                                                    type="text"></td>
        ...
        <div class="uk-padding uk-background-muted uk-padding " style="text-align: center;">
            <div class="uk-div uk-margin position-relative .uk-padding-large" style="text-align: center;">
                ...
                <a onclick="return confirm('¿Está seguro que desea continuar?')" id="guardar"
                    href="/menu/menu_facturacion/form_sublimacion" class="uk-button uk-button-secondary"
