...
<head>
    ...
    <title>Sericolor | Conocenos</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-3" style="background-color: #d9d9d9;">
        ...
        <div class="navbar-collapse collapse" id="navbarColor02">
            <ul class="navbar-nav me-auto mb-3 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/acerca"> <b> Conócenos </b></a>
    ...
    <div class="p-3">
        <div class="card mb-3 text-center">
            ...
            <div class="card-body">
                ...
                <p class="card-text" style="font-size: 18px;">Hace 8 años comenzó este proyecto, estábamos llenos
                    de
                    ...
                    obedecimos, aquí estamos son tantas historias buenas y malas que contar pero lo mejor ha sido el
                    propósito que Dios tiene con nosotros, hoy damos Gracias al Eterno PADRE por este tiempo.</p>
