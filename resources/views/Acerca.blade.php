...
<body style="background-color:bisque">
    ...
    <div uk-margin-right class="uk-padding">
        ...
        <!-- Botones para acceder a las distintas pestañas de la pagina web-->
    ...
    <div>
        <div class="uk-grid-medium uk-child-width-expand@s uk-text-center" uk-grid>
            <div>
                <img class="img-thumbnail rounded mx-auto d-block" uk-margin data-src="/img/FrenteSericolor.jpg" width="800" height="720" alt="" uk-img>
            </div>
        </div>
        <div>
        ...
        <div class="uk-padding">
            ...
            Hace 8 años comenzó este proyecto, estábamos llenos de muchas dudas y miedos, pero era mas fuerte las ganas de crear una empresa, hubieron obstaculos, personas que decían: "no creo que puedan", pero seguimos lo que nuestro corazón dictaba y obedecimos, aquí estamos son tantas historias buenas y malas que contar pero lo mejor ha sido el propósito que Dios tiene con nosotros, hoy damos Gracias al Eterno PADRE por este tiempo.
            </h3>
        </div>
    <div>
