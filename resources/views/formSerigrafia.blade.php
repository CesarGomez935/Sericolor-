                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input id="talla_s_caballero" name="talla_s"
                                                class="uk-input uk-form-width-xsmall" type="Number" value="0"
                                                placeholder="0"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="talla_m_caballero" name="" class="uk-input uk-form-width-xsmall"
                                                value="0" type="Number" placeholder="0"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="talla_l_caballero" class="uk-input uk-form-width-xsmall"
                                                type="Number" value="0" placeholder="0"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="talla_xl_caballero" class="uk-input uk-form-width-xsmall"
                                                value="0" type="Number" placeholder="0"></td>
                                        <td><input id="talla_xl_dama" class="uk-input uk-form-width-xsmall" value="0"
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="talla_2xl_caballero" class="uk-input uk-form-width-xsmall"
                                                value="0" type="Number" placeholder="0"></td>
                                        <td><input id="talla_2xl_dama" class="uk-input uk-form-width-xsmall" value="0"
                                                type="Number" placeholder="0"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input id="talla_3xl_caballero" class="uk-input uk-form-width-xsmall"
                                                value="0" type="Number" placeholder="0"></td>
                                        <td><input id="talla_3xl_dama" class="uk-input uk-form-width-xsmall" value="0"
                                                type="Number" placeholder="0"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input id="talla_5xl_caballero" class="uk-input uk-form-width-xsmall"
                                                value="0" type="Number" placeholder="0"></td>
                                        <td><input id="talla_5xl_dama" class="uk-input uk-form-width-xsmall" value="0"
                                                type="Number" placeholder="0"></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <table class="uk-table uk-table-hover uk-table-divider">
                        ...
                        <tbody id="tabladetalle">
                            ...
                            <tr>
                                ...
                                <td><input id="total_pedido" type="number" placeholder="0" value="0" class="uk-input"
                                        disabled></td>
                            </tr>
                        </tbody>
