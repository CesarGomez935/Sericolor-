...
<head>
    ...
    <title>Editar | Impresión Digital</title>
        ...
        <div>
            ...
            <div class="uk-child-width-1-2 uk-text-center uk-background-muted uk-padding" uk-grid>
                            ...
                            <div class="uk-form-controls">
                                <div class="uk-inline">
                                    ...
                                    <input id="saldo" name="Saldo" class="uk-input uk-form-width-large"
                                        id="form-horizontal-text" value="{{ $edit->saldo }}" type="number"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="uk-form-horizontal uk-margin-large">
                        ...
                        <div class="uk-margin">
                            <label for="autriza" class="uk-form-label" for="form-horizontal-text">Cod.
                                Seguimiento</label>
                            <div class="uk-form-controls">
            ...
            <div class="uk-padding uk-background-muted uk-padding  ">
                <div class="uk-div uk-margin position-relative .uk-padding-large" style="text-align: center;">
                    ...
                    <a id="guardar" href="/menu/pedidos_impresion_digital"
                        class="uk-button uk-button-secondary guardar" style="margin-left: 100px">Guardar</a>
            ...
            <div class="uk-margin">
                <input class="uk-input" disabled hidden type="text" value="{{ $edit->idmaestro }}"
                    id="idmaster" placeholder="nada">
            </div>
        </div>
