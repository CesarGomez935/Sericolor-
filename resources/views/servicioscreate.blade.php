...
<body>
    ...
    <form action="{{ url('/menu/menuadmon/servicios/create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="uk-div uk-padding">
                    <div class="uk-section-secondary uk-margin uk-padding" style="text-align: center;">
                        ...
                        <div class="uk-margin" uk-margin>
                                ...
                                <div class="uk-margin" uk-margin>
                                    ...
                                    <div uk-form-custom="target: true">
                                        ...
                                        <input class="uk-input uk-form-width-medium" type="text"
                                            placeholder="Seleccionar Icono" disabled>
                                    </div>
                                    ...
                                    <div uk-form-custom="target: true">
                                        ...
                                        <input class="uk-input uk-form-width-medium" type="text"
                                            placeholder="Seleccionar Representación" disabled>
                                    </div>
                            ...
                            <h6>Título</h6>
                            <div class="uk-margin">
                                <input name="titulo" class="uk-input" type="text" placeholder="Ej. Bordado">
                            </div>
                            ...
                            <button onclick="return confirm('¿Está seguro que desea continuar?')" id="guardar"
                                type="submit" class="uk-button uk-button-default">Cargar Servicio</button>
