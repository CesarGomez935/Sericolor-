                ...
                <tbody>
                    <tr>
                        <td style="padding-left: 100px;">
                            <a href="/menu/menu_facturacion" class="btn btn-lg uk-padding" style="background-color:transparent">
                                <div style="text-align:center"><svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
                        ...
                        <td style="padding-left: 100px;">
                            <a href="/menu/pedidos_sublimacion" class="btn btn-lg uk-padding " style="background-color:transparent">
                        ...
                        <td style="padding-left: 100px;">
                            <a href="/menu/pedidos_impresion_digital" class="btn btn-lg" style="background-color:transparent">
