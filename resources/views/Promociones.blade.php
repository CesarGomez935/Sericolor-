        ...
        <div>
            <div class="uk-div uk-padding">
                ...
                <div class="uk-section-secondary uk-margin uk-padding" style="text-align: center;">
                    ...
                    <div class="uk-div uk-padding">
                        <a href="/menu/menuadmon/slider/create" class="uk-button uk-button-primary">Agregar Nueva
                            Imagen</a>
                    </div>
                ...
                <tbody id="datos">
                    @foreach ($slider as $item)
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('uploads/slider/' . $item->Imagen) }}" width="400" height="200"
                                    srcset=""> </td>
                            ...
                            <td>
                                <a href="{{ url('/menu/menuadmon/slider/edit/' . $item->Idslider) }}"
                                ...
                                <a onclick="return confirm('¿Está seguro que desea continuar?')"
                                    href="{{ url('/menu/menuadmon/slider/delete/' . $item->Idslider) }}"
