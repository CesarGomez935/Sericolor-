    ...
    <nav class="navbar navbar-expand-lg navbar-light p-3" style="background-color: #d9d9d9;">
        ...
        <div class="navbar-collapse collapse" id="navbarColor02">
            <ul class="navbar-nav me-auto mb-3 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active " aria-current="page" href="/galeria"><b> Galería </b></a>
...
<body style="background-color:white">
    ...
    <div data-mc-src="74f87abd-816d-477c-a6b9-43213cfda226#instagram"></div>
