    ...
    <form action="" method="post">
                ...
                <div>
                    <div class="uk-child-width-1-3 uk-text-center uk-margin-small" uk-grid>
                            ...
                            <div class="uk-grid-small" uk-grid>
                                <table class="uk-table uk-table-hover uk-table-divider uk-table-small">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>S</td>
                                            <td><input id="talla_s_caballero" class="uk-input uk-form-width-xsmall"
                                        ...
                                        <tr>
                                            <td>M</td>
                                            <td><input id="talla_m_caballero" class="uk-input uk-form-width-xsmall"
                                                    type="Number" placeholder="0"></td>
                        ...
                        <div class="">
                            ...
                            <div class="uk-grid-small" uk-grid>
                                <table
                                    class="uk-table uk-table-hover uk-table-divider uk-table-small uk-margin uk-padding-small">
                                    <thead>
                                        <tr>
                                            <th>Talla Juvenil</th>
                                            <th>Cantidad</th>
                                    ...
                                    <tbody id="tabladetalle">
                                        <tr>
                                            ...
                                            <td><input id="precio_pedido_1" onchange="pedido();" onclick="pedido();"
                                                    min="0" class="uk-input pedido" type="number"></td>
            ...
            <div>
                ...
                <div class="uk-form-horizontal uk-margin-large">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input id="banco" name="Banco" class="uk-input uk-form-width-large"
                                id="form-horizontal-text" type="text" placeholder="">
                        </div>
                    </div>
        ...
        <div class="uk-padding uk-background-muted uk-padding " style="text-align: center;">
            <div class="uk-div uk-margin position-relative .uk-padding-large" style="text-align: center;">
                ...
                <a id="guardar" href="/menu/menu_facturacion/form_sublimacion" class="uk-button uk-button-secondary"
