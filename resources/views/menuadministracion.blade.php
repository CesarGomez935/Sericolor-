...
<body>
            ...
            <table class="uk-table uk-padding  uk-margin">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 100px">
                            <a href="/menu/menuadmon/insumos" class="btn btn-lg" style="background-color:transparent">
                                <div style="text-align:center"><svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-boxes" viewBox="0 0 16 16">
                        ...
                        <td style="padding-left: 100px">
                            <a href="/menu/menuadmon/promociones" class="btn btn-lg" style="background-color:transparent">
                                ...
                                <div style="text-align:center"><svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-display" viewBox="0 0 16 16">
    ...
    <div class="uk-padding  uk-padding  ">
        <div class="uk-div uk-margin position-relative .uk-padding-large" style="text-align: center;">
            <a href="/menu" class="uk-button uk-button-primary " style="margin-left: 1px">Atrás</a>
...
<footer>
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary">
        <!-- Copyright -->
        <div class="text-white mb-3 mb-md-0">
            <a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/4.0/"><img alt="Licencia Creative Commons" style="border-width:02 src=" https2//i.creativecommons.org/l/by-nc-nd/4.0/88x31.png" /></a><br />Esta obra está bajo una <a rel="license" style="color: black" href="http://creativecommons.org/licenses/by-nc-nd/4.0/">Licencia Creative Commons Atribución-NoComercial-SinDerivadas 4.0 Internacional</a>.
