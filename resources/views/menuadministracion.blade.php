            ...
            <tbody>
                <tr>
                    <td style="padding-left: 50px;">
                        <a href="/resumen_pedidos" class="btn btn-lg uk-padding " style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;">
                        <a href="/personal" class="btn btn-lg" style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;"> 
                        <a href="/reportes" class="btn btn-lg" style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;">
                        <a href="/bd" class="btn btn-lg" style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;">
                        <a href="/clientes" class="btn btn-lg" style="background-color:transparent">
