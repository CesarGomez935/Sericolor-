                        ...
                        <div class="uk-grid-small" uk-grid>
                            <table class="uk-table uk-table-hover uk-table-divider uk-table-small">
                                ...
                                <script>
                                    ...
                                    function peticionabor(data, method, onSuccess) {


                                        let url = '/api/getinsumobor';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="uk-inline">
                                                ...
                                                <span class="uk-form-icon">C$</span><input disabled id="sub_total" type="number" min="0" class="uk-input uk-form-width-small ">
                                            </div>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="uk-inline">
                                    ...
                                    <span class="uk-form-icon">C$</span><input class="uk-form-width-small uk-input saldo" disabled id="total"></input>
                                </div>
                            </td>
