...
<head>
    ...
    <title>Sericolor | Servicios</title>
...
<header>
    ...
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 "
        ...
        <div id="informacion" class="text-white mb-3 mb-md-0">
            ...
            <a href="https://web.whatsapp.com/send?phone=+505+55038173" target="_blank" class="text-white me-4">
...
<body onload="setTimeout(scroll, 500);">
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-3" style="background-color: #d9d9d9;">
        ...
        <div class="navbar-collapse collapse" id="navbarColor02">
            <ul class="navbar-nav me-auto mb-3 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/servicio"><b>Servicios</b></a>
    ...
    <div class="botones btn-group-vertical" role="group" aria-label="Vertical button group">
        <a type="button" href="https://api.whatsapp.com/send?phone=+505 55038173" target="_blank"
            class="btn btn-primary" style="background-color:#003399 ">
        ...
        <a type="button" href="https://es-la.facebook.com/pg/sericolorpublicidad" target="_blank"
            class="btn btn-primary" style="background-color:#003399 ">
        ...
        <a type="button" href="https://www.instagram.com/sericolorpublicidad/?hl=es-la" target="_blank"
            class="btn btn-primary" style="background-color:#003399 ">
    ...
    <div id="servicios" class="p-5 mx-auto">

        <div id="sublimacion" class="card text-dark bg-light mb-3 mx-auto" style="max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="/img/sublimacion1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 style="font-size: 20px;" class="card-title"><b>Sublimación</b></h5>
                        <p style="text-align: justify; font-size:18px;" class="card-text">Sublimación es el
                            proceso
                            de arte gráfico con
                            el cual se logra la impresión
                            del color
                            sobre la tela usando altas temperaturas para realizar una fusión entre las moléculas de
                            color y las de la tela.</p>
        ...
        <div id="impresion_digital" class="card text-dark bg-light mb-3 mx-auto" style="max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="/img/Impresiondigital1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 style="font-size: 20px;" class="card-title"><b>Impresión Digital</b></h5>
                        <p style="text-align: justify; font-size:18px;" class="card-text">Cuando hablamos de
                            impresión
                            digital, hacemos referencia al proceso de impresión directa de un archivo digital a
                            cualquier tipo de material (papel, vinilo, tejidos…). Un claro ejemplo sería imprimir un
                            documento o imagen con una impresora láser o de tinta.</p>
        ...
        <div id="bordado" class="card text-dark bg-light mb-3 mx-auto" style="max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="/img/bordado1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
        ...
        <div id="serigrafia" class="card text-dark bg-light mb-3 mx-auto" style="max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="/img/serigrafia1.jpg" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 style="font-size: 20px;" class="card-title"><b>Serigrafía</b></h5>
                        <p style="text-align: justify; font-size:18px;" class="card-text">La serigrafía es una
                            técnica
                            ...
                            tinta se bloquea en las áreas donde no habrá imagen mediante una emulsión o barniz, quedando
...
<footer>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="m-1 p-2">
                    <h3 style="text-align: center" class="text-primary"> <b> Ubicación </b></h3>
                </div>
            </div>
            <div class="col">
                <div class="m-1 p-2">
                    <h3 style="text-align: center" class="text-primary"> <b> Promociones </b></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="map-responsive" height="150" width="200" style="text-align: center">
                    <iframe class="embed-responsive-item"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.6598222185626!2d-85.92170308581036!3d12.929572019298973!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f7249d2987e4149%3A0x1e72bbacc5e03499!2sSERICOLOR%20PUBLICIDAD!5e0!3m2!1ses!2sni!4v1629494741812!5m2!1ses!2sni"></iframe>
            ...
            <div class="col">
                <div class="">
                    ...
                    <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1"
                        uk-slideshow="min-height: 1; max-height: 200; animation: push; autoplay: true">
        ...
        peticionapiservicios({}, "GET", function(res) {
            ...
            res.forEach(servicios => {
                html +=
                    ...
                    '" class="card text-dark bg-light mb-3 mx-auto" style="max-width: 1000px;">' +
                    '  <div class="row g-0">' +
                    ' <div class="col-md-4">' +
                    '  <img src="/uploads/servicios/' + servicios.imagenrep +
                    '" class="img-fluid rounded-start" alt="...">' +
                    '</div>' +
                    '<div class="col-md-8">' +
                    '<div class="card-body">' +
                    '<h5 style="font-size: 20px;" class="card-title"><b>' + servicios.titulo +
                    '</b></h5>' +
                    '<p style="text-align: justify; font-size:18px;" class="card-text">' + servicios
                    .descripcion + '</p>' +
