        ...
        <div>
            <div id="serigrafia" class="uk-height-medium uk-card uk-card-default uk-card-body uk-flex uk-flex-middle uk-flex-left uk-padding " style="background-color:bisque">
                ...
                <h1 class="uk-padding">Serigrafía
                    <div>
                        <h3 class="uk-text-justify">La Serigrafía es un procedimiento de impresión que consiste en el paso de la tinta a través de una plantilla que sirve de enmascaramiento, unida a una trama tensada en un bastidor. </h3>
