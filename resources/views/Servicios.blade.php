...
<header>
    ...
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 " style="background-color: #003399">
...
<body>
    ...
    <div class="botones btn-group-vertical" role="group" aria-label="Vertical button group">
        <a type="button" href="https://api.whatsapp.com/send?phone=+505 55038173" target="_blank" class="btn btn-primary" style="background-color:#003399 ">
        ...
        <a type="button" href="https://es-la.facebook.com/pg/sericolorpublicidad" target="_blank" class="btn btn-primary" style="background-color:#003399 ">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
            </svg>
        </a>
        <a type="button" href="https://www.instagram.com/sericolorpublicidad/?hl=es-la" target="_blank" class="btn btn-primary" style="background-color:#003399 ">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p style="text-align: justify; font-size:18px;" class="card-text">Cuando hablamos de impresión
