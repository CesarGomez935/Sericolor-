...
<body>
            ...
            <tbody>
                <tr>
                    <td style="padding-left: 100px;">
                        <a href="/form_sublimacion" href="/form_sublimacion" class="btn btn-lg uk-padding " style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;">
                        <a href="/form_impresion_digital" class="btn btn-lg" style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;"> 
                        <a href="/form_serigrafia" class="btn btn-lg" style="background-color:transparent">
                    ...
                    <td style="padding-left: 100px;">
                        <a href="/form_bordado" class="btn btn-lg" style="background-color:transparent">
    ...
    <div class="uk-padding uk-background-muted uk-position-bottom uk-padding  ">
        <div class="uk-div uk-margin position-relative .uk-padding-large" style="text-align: center;">
            <a href="/menu" class="uk-button uk-a-primary " style="margin-left: 100px">Atrás</a>
