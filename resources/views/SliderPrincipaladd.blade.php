...
<body>
    ...
    <nav class="uk-navbar uk-navbar-container">
        <div class="uk-navbar-left">
            <a class="uk-navbar-toggle" href="#">
                <span uk-toggle="target: #my-id" uk-navbar-toggle-icon></span> <span class="uk-margin-small-left">Slider</span>
            </a>
        </div>
    ...
    <form action="{{ url('/menu/menuadmon/slider/create') }}" method="post" enctype="multipart/form-data">
