                    ...
                    <div class="card" style="border-radius: 1rem ;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="/img/Logo_sericolor.png" alt="login form" class="img-fluid uk-padding"
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ingrese el código
                                            que esta en su factura</h5>

                                        <div class="form-outline mb-4">
                                            <input autofocus type="text" id="codigo_seg"
                                                class="form-control form-control-lg" />

                                            <label class="form-label" for="form2Example17">código</label>
                                        </div>
                                        <div class="pt-1 mb-4">
                                            <button id="revisar" onclick="cargarRevision();"
                                                class="btn btn-dark btn-lg btn-block" type="button">Revisar</button>
...
<script>
    ...
    function mostrar(id) {
        ...
        $("#Nombre").val(detalle.Primer_Nombre + " " + detalle.Segundo_Nombre + " " + detalle.Primer_Apellido + " " +
            detalle.Segundo_Apellido), $("#Estado").val(detalle.Estado)
